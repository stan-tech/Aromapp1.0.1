      ...
      /*  private void Control_Click(object sender, EventArgs e)
        {
            ...
            int index = accounts.Controls.IndexOf(clickedControl);
            Adapter.Click(index);
            Adapter.selectedItem = items[index];
        ...
        void DeleteClick(object sender, EventArgs e)
        {
            /* Button clickedButton = (Button)sender;
             ...
             AccountItem parentItem = (AccountItem)clickedButton.Parent;

             int index = accounts.Controls.IndexOf(parentItem);
                        Adapter.deleteSupplier(index);
